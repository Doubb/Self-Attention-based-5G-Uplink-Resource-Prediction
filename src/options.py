...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--normalization',
                                 choices={'standardization', 'minmax', 'per_sample_std', 'per_sample_minmax', 'robust', 'nothing'},
        ...
        # Training process
        self.parser.add_argument('--task', choices={"imputation", "transduction", "classification", "regression", "regression_RMSE"},
                                 default="imputation",
        ...
        # Model
        self.parser.add_argument('--model', choices={"transformer", "LINEAR", "original_transformer", "measure"}, default="transformer",
                                 help="Model class")
